...
def welcomeScreen():
    ...
    messagex = int((SCREENWIDTH - GAME_SPRITES['messag'].get_width())/2)
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by Tanuj')
    ...
    GAME_SPRITES['messag'] =pygame.image.load('gallery/sprites/messag.png').convert_alpha()
